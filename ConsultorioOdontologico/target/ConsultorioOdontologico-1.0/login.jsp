<%-- 
    Document   : login
    Created on : 2 mar. 2024, 20:15:25
    Author     : Johnny
--%>
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <img src="https://www.rmodontologia.com.ar/images/portada/400x300joseriquelme.jpg" alt="alt"/>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="SvLogin" method="POST">
                                            <div class="form-group">
                                                <input class="form-control form-control-user"
                                                       id="user" name="user"  placeholder="Usuario">
                                            </div>
                                            <div class="form-group">
